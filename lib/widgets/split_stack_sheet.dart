...
class SplitStackSheet extends StatefulWidget {
  final Item item;
  final VoidCallback?
      onSplitCompleted; // Optional callback from ExpandedTokenView
...
class _SplitStackSheetState extends State<SplitStackSheet> {
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(
                            child: TextField(
                              controller:
                                  TextEditingController(text: '$_splitAmount'),
                    ...
                    // Split button
                    ElevatedButton(
                      onPressed: _splitAmount >= widget.item.amount
                          ? null
                          : _performSplit,
  ...
  SplitResult _calculateSplit() {
    ...
    if (_tappedFirst) {
      ...
      final newTapped =
          _splitAmount < currentTapped ? _splitAmount : currentTapped;
      ...
      final newUntapped =
          _splitAmount < availableUntapped ? _splitAmount : availableUntapped;
