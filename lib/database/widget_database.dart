...
class WidgetDatabase extends ChangeNotifier {
  ...
  void loadWidgets() {
    _widgets = [
      ...
      WidgetDefinition(
        ...
        name: 'Life Total',
        description:
            '', // No description needed - players know what life totals are
      ...
      WidgetDefinition(
        ...
        description:
            '', // No description needed - players know what poison counters are
  ...
  void _applyFilters() {
    ...
    if (_searchQuery.isNotEmpty) {
      filtered =
          filtered.where((w) => w.matches(searchQuery: _searchQuery)).toList();
    }
